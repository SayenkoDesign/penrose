...
if ( !defined('FCA_PC_PLUGIN_DIR') ) {
	...
	define( 'FCA_PC_PLUGIN_VER', '1.1.2' );
	...
	define( 'FCA_PC_PLUGIN_NAME', 'ConvertCat: ' . FCA_PC_PLUGIN_PACKAGE );
		...
		function fca_pc_admin_deactivation_survey( $hook ) {
			if ( $hook === 'plugins.php' ) {
				...
				<div id="fca-deactivate" style="position: fixed; left: 232px; top: 191px; border: 1px solid #979797; background-color: white; z-index: 9999; padding: 12px; max-width: 669px;">
					...
					<p><?php _e( 'Hi, this is David, the creator of ConvertCat. Thanks so much for giving my plugin a try. I’m sorry that you didn’t love it.', 'pixel-cat' ) ?>
					</p>
					<p><?php _e( 'I have a quick question that I hope you’ll answer to help us make ConvertCat better: what made you deactivate?', 'pixel-cat' ) ?>
					</p>
