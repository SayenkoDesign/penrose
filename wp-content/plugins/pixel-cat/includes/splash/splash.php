...
function fca_pc_render_splash_page() {
	...
	echo '<form method="post" action="' . admin_url( '/admin.php?page=pixel-cat-splash' ) . '">';
		...
		echo '<div id="fca-splash">';
			echo '<h1>' . __( 'Welcome to ConvertCat', 'pixel-cat' ) . '</h1>';
			
			echo '<div id="fca-splash-main" class="fca-splash-box">';
				echo '<p id="fca-splash-main-text">' .  sprintf ( __( 'In order to enjoy all our features and functionality, ConvertCat needs to connect %1$s your user, %2$s at %3$s, to <strong>api.fatcatapps.com</strong>.', 'pixel-cat' ), '<br>', '<strong>' . $name . '</strong>', '<strong>' . $website . '</strong>'  ) . '</p>';
				echo "<button type='submit' id='fca-pc-submit-btn' class='fca-pc-button button button-primary' name='fca-pc-submit-optin' >" . __( 'Connect ConvertCat', 'pixel-cat') . "</button><br>";
